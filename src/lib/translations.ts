...
export const translations = {
  ru: {
    ...
    admin_role_junior: "Junior",
    admin_role_worker: "Рабочий",
    admin_session_dialog_promote_title: "Передать права старшего?",
    admin_session_dialog_promote_desc: "Вы уверены, что хотите сделать устройство \"{deviceName}\" старшим? Вы потеряете свои права.",
    ...
    admin_session_promote_success_desc: "Устройство {deviceName} теперь старшее.",
  ...
  uz: {
    ...
    admin_session_promote_button: "Kattaga aylantirish",
    ...
    admin_session_dialog_promote_title: "Katta huquqini berasizmi?",
    admin_session_dialog_promote_desc: "\"{deviceName}\" qurilmasini katta qilishga ishonchingiz komilmi? Siz o'z huquqlaringizni yo'qotasiz.",
    ...
    admin_session_promote_success_desc: "{deviceName} qurilmasi endi katta.",
