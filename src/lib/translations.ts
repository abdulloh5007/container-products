...
export const translations = {
  ru: {
    ...
    admin_rental_amount_label: "Сумма аренды",
    admin_rental_form_error_desc: "Пожалуйста, укажите номер контейнера и сумму аренды.",
    ...
    admin_rental_search_placeholder: "Поиск по номеру контейнера...",
  ...
  uz: {
    ...
    admin_rental_amount_label: "Ijara summasi",
    admin_rental_form_error_desc: "Iltimos, konteyner raqamini va ijara summasini kiriting.",
    ...
    admin_rental_search_placeholder: "Konteyner raqami bo'yicha qidirish...",
